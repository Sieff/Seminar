...
font_size = 32
tex_red_area = Tex(r'$< \frac{1}{\beta} area(t_i)$', font_size=font_size)
tex_blue_area = Tex(r'$> \frac{1}{\beta} area(t_i)$', font_size=font_size)
...
tex_gt_area = Tex(r'$> \frac{1}{\beta} area(t_i)$', font_size=font_size)
tex_lt_area = Tex(r'$< \frac{2}{\beta} area(t_i)$', font_size=font_size)
